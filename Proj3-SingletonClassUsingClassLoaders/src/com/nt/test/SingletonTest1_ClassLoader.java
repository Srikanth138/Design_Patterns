...
public class SingletonTest1_ClassLoader {
	public static void main() throws MalformedURLException, ClassNotFoundException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		URLClassLoader loader1=new URLClassLoader(new URL[] {new URL("file:C:/Users/srika/Desktop/war/sdp.jar") }, p1.getClass().getClassLoader());
