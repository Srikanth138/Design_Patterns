...
public class SignletonTest1_ReflectionAPI {
	public static void main(String[] args) {
		...
		try {
			//get java.lang.Class object representing Printer1 class
			Class c=p1.getClass();  //getClass() is public method of java.lang.Object class.
			//get All costructor of Printer1 class
			  Constructor cons[]= c.getDeclaredConstructors();
			  cons[0].setAccessible(true); 
			  //gives access to private constructor create object using the accessed private constructor
